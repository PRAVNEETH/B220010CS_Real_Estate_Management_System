<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        ...
                                        <p class="pb-20 text-white">Shin State is a dynamic and innovative real estate agency that takes pride in redefining the real estate experience for our clients. With a passion for excellence, we have established ourselves as a trusted name in the industry, driven by a commitment to professionalism and outstanding service.</p>
										<p class="pb-20 text-white"> Our team of seasoned real estate professionals brings a wealth of experience and expertise to every transaction, ensuring that clients receive tailored solutions to meet their unique needs.</p>
                                        </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget footer-nav mb-4">
                                                ...
                                                <ul class="hover-text-primary">
                                                    ...
                                                    <li><a href="#" class="text-white">Frequenly Ask Question</a></li>
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>BHU Main Gate Lanka, Varanasi</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 8080900102</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 7010221376</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>helpline@shin.com</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© 2023 Shin All right reserved</span> </div>
                    <div class="col-sm-6">
