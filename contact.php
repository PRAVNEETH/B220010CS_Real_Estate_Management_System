...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 mb-5" style="background:#6fda6f">
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-secondary">BHU Main Gate Lanka, Varanasi, Uttar Pradesh</span> 
										<span class="text-secondary">BHU Main Gate Lanka, Varanasi, Uttar Pradesh</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="d-table text-secondary">7010221376</span>
										<span class="text-secondary">8080900102</span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-secondary">helpline@shin.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
        ...
        <iframe src="https://www.google.com/maps/embed/v1/place?q=Varanasi&key=AIzaSyBMhwkpg1zTgqO34q5fEQzFgPc1n5uZxDI" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
